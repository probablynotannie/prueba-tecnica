...
export default function BattlePage() {
    ...
    const roundsWithStats = result && teamA && teamB
        ? (() => {
            let indexA = 0
            let indexB = 0
            ...
            return result.rounds.map(round => {
                ...
                const winner =
                    round.winner === pokemonA.name ? pokemonA : pokemonB
                const loser =
                    winner === pokemonA ? pokemonB : pokemonA
    ...
    return (
        <div className="rounded-xl border shadow-lg hover:shadow-xl transition duration-300 bg-slate-50 p-5 border-slate-200">
            ...
            <div className=" mb-4 grid lg:grid-cols-2 gap-10">
                            ...
                            return (
                                ...
                                >
                                    <div className='flex items-start gap-2'>
                                        <FaTrophy className='text-xl text-pink-700' /> <span className="capitalize text-pink-600">{round.winner.name}</span> derrota a{' '}
                                        <span className="capitalize text-red-400">{round.loser.name}</span>
                                    </div>
